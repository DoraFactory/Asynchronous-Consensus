...
use super::{EncryptionSchedule, Dumbo, Params, SubsetHandlingStrategy};
use crate::{Contribution, NetworkInfo, NodeIdT};

/// A Dumbo builder, to configure the parameters and create new instances of `Dumbo`.
pub struct DumboBuilder<C, N> {
    /// Shared network data.
    ...
    N: NodeIdT,
{
    ...
    /// Creates a new Dumbo instance.
    pub fn build(&mut self) -> Dumbo<C, N> {
        Dumbo {
